...
' Call Single Run
    Call automation
     ...
     '       dofile = RemoveBackSlash(Range("Stata_Dofile_Path").Text) & "\DoFiles\v1_2026_FinanceModel\Premium Calculation.do"
...
' Brandon edit - Loan Type variable
  ...
  dofile = RemoveBackSlash(Range("Stata_Dofile_Path").Text) & "\DoFiles\v1_2026_FinanceModel\DFC Obligation Master Dofile.do"
...
' Command line to open Stata and run the dofile
  ...
  cmd_line = cmd_line & " do " & " " & dofile & " " & DoFilePath & " " & PPS & " " & "v1_2026_FinanceModel" & " " & OSF & " " & FSS & " " & FXC & " " & CurrencyType & " " & LoanOfficer
  'cmd_line = cmd_line & " do " & " " & dofile & " " & DoFilePath & " " & PPS & " " & "v1_2026_FinanceModel" & " " & OSF & " " & FSS & " " & FXC & " " & CurrencyType
...
' Brandon edit - Loan Type variable
  ...
  dofile = RemoveBackSlash(Range("Stata_Dofile_Path").Text) & "\DoFiles\v1_2026_FinanceModel\Save Results.do"
